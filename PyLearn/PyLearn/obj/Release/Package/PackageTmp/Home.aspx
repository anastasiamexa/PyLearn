<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="PyLearn.Home" %>
          ...
          <div class="u-layout-row" style="">
            <div class="u-align-left u-container-style u-layout-cell u-left-cell u-shape-rectangle u-size-20-lg u-size-20-xl u-size-23-md u-size-23-sm u-size-23-xs u-size-xs-60 u-layout-cell-1" src="">
              <div class="u-container-layout u-container-layout-1">
                <h1 class="u-text u-text-body-alt-color u-text-1" data-animation-name="fadeIn" data-animation-duration="1000" data-animation-direction="Left" data-animation-delay="250">Μπες στον κόσμο της Python</h1>
                <p class="u-text u-text-body-alt-color u-text-2" data-animation-name="fadeIn" data-animation-duration="1000" data-animation-direction="Up" data-animation-delay="250">Με το PyLearn μπορείς να μάθεις τις βασικές έννοιες της γλώσσας προγραμματισμού Python εύκολα και γρήγορα.</p>
                <a href="https://nicepage.com/k/blank-html-templates" class="u-border-none u-btn u-btn-round u-button-style u-palette-3-base u-radius-10 u-text-palette-1-base u-btn-1" data-animation-name="fadeIn" data-animation-duration="1000" data-animation-direction="Up" data-animation-delay="500">Κατεβασε την εφαρμογη</a>
              </div>
            </div>
              ...
              <div class="u-layout-col">
                ...
                <div class="u-align-center u-container-style u-layout-cell u-radius-20 u-right-cell u-shape-round u-size-40 u-white u-layout-cell-2" data-animation-name="fadeIn" data-animation-duration="1000" data-animation-direction="Left" data-animation-delay="250">
                  <div class="u-container-layout u-container-layout-2">
                    ...
                    <h4 class="u-text u-text-1">Λειτουργίες Μαθητή</h4>
                    <p class="u-text u-text-2">Δίνεται η δυνατότητα στους μαθητές να διαβάσουν την θεωρία ανά κεφάλαιο.<br>Να εξασκηθούν όσες φορές θέλουν σε τεστ κλιμακούμενης δυσκολίας και<br>να αξιολογηθούν ολοκληρώνοντας το τελικό διαγώνισμα.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="u-layout-col">
                ...
                <div class="u-align-center u-container-style u-layout-cell u-left-cell u-size-20 u-white u-layout-cell-4">
                  <div class="u-container-layout u-container-layout-4">
                    <h4 class="u-text u-text-default u-text-3">Λειτουργίες Καθηγητή</h4>
                    <p class="u-text u-text-4">
                      <span style="font-size: 1.25rem;">Οι καθηγητές μπορούν να παρακολουθήσουν την πρόοδο των μαθητών τους, καθώς και να επικοινωνήσουν μαζί τους ενημερώνον΄τας τους για αυτήν.</span>
                      <br>
                    </p>
                  </div>
                </div>
        ...
        <div class="u-repeater u-repeater-1">
          <div class="u-container-style u-list-item u-radius-20 u-repeater-item u-shape-round u-white u-list-item-1" data-animation-name="flipIn" data-animation-duration="1000" data-animation-direction="X" data-animation-delay="250">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1">
              ...
              <p class="u-text u-text-2">Μελέτησε την θεωρία κάθε κεφαλαίου.</p>
            </div>
          </div>
          <div class="u-container-style u-list-item u-radius-20 u-repeater-item u-shape-round u-white" data-animation-name="flipIn" data-animation-duration="1000" data-animation-direction="X" data-animation-delay="250">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-2">
              ...
              <p class="u-text u-text-4">Εξασκήσου όσες φορές θες σε εύκολα και δύσκολα τεστ για κάθε κεφάλαιο.</p>
            </div>
          </div>
          <div class="u-container-style u-list-item u-radius-20 u-repeater-item u-shape-round u-white" data-animation-name="flipIn" data-animation-duration="1000" data-animation-direction="X" data-animation-delay="250">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-3">
              <h3 class="u-text u-text-default u-text-palette-1-base u-text-5">03</h3>
              <p class="u-text u-text-6">Ολοκλήρωσε το τεστ αξιολόγησης και έλεγξε τις γνώσεις σου. </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-container-style u-grey-5 u-group u-radius-20 u-shape-round u-group-1">
          <div class="u-container-layout u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-container-layout-1">
            <h3 class="u-align-center u-text u-text-1"> ❝Good things don’t come easy❞</h3>
            <p class="u-align-left u-text u-text-2">Ωστόσο, η πρόσβαση στη γνώση γίνεται πανεύκολη με το PyLearn.<br>Ξεκίνα τώρα το ταξίδι σου στον κόσμο του προγραμματισμού.
            </p>
            <a href="https://nicepage.cc" class="u-border-none u-btn u-btn-round u-button-style u-palette-3-base u-radius-10 u-text-palette-1-base u-btn-1">Κατεβασε την εφαρμογη</a>
          </div>
        </div>
        <div class="u-gradient u-shape u-shape-circle u-shape-2"></div>
      </div>
    </section>
    <section class="u-clearfix u-grey-5 u-section-5" id="sec-bf70">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-container-style u-group u-radius-20 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h2 class="u-text u-text-1">Δες την πρόοδο σου και ενημερώσου για τα λάθη σου.</h2>
            <a href="https://nicepage.com/c/video-website-templates" class="u-border-none u-btn u-btn-round u-button-style u-palette-3-base u-radius-10 u-text-palette-1-base u-btn-1">Συνδεση</a>
          </div>
        </div>
        <div class="u-list u-list-1">
          <div class="u-repeater u-repeater-1">
            <div class="u-container-style u-list-item u-radius-20 u-repeater-item u-shape-round u-video-cover u-white u-list-item-1">
              <div class="u-container-layout u-similar-container u-valign-top u-container-layout-2"><span class="u-file-icon u-icon u-icon-circle u-palette-3-base u-text-palette-1-dark-1 u-icon-1"><img src="images/3079079.png" alt=""></span>
                <h4 class="u-align-center u-text u-text-palette-1-base u-text-2">Λογικα Λαθη</h4>
              </div>
            </div>
            <div class="u-align-center u-container-style u-list-item u-radius-20 u-repeater-item u-shape-round u-video-cover u-white u-list-item-2">
              <div class="u-container-layout u-similar-container u-valign-top u-container-layout-3"><span class="u-file-icon u-icon u-icon-circle u-palette-3-base u-text-palette-1-dark-1 u-icon-2"><img src="images/6515175.png" alt=""></span>
                <h4 class="u-align-center-sm u-align-center-xs u-text u-text-palette-1-base u-text-3">Συντακτικα λαθη</h4>
              </div>
            </div>
          </div>
        </div>
