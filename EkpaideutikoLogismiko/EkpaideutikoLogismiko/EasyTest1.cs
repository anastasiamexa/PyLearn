...
{
    public partial class EasyTest1 : Form
    {
        ...
        public EasyTest1(string u)
        {
            ...
            string query = "select * from multiplechoice inner join questions on multiplechoice.id= questions.id where chapter=1";
            ...
            string query2 = "select * from truefalse inner join questions on truefalse.id= questions.id where chapter=1";
            ...
            else
            {
                ...
                question.Text = ((MultipleChoice)o).question;
        ...
        private void EasyTest1_MouseDown(object sender, MouseEventArgs e)
        {
            _dragging = true;
            _start_point = new Point(e.X, e.Y);
        }

        private void EasyTest1_MouseMove(object sender, MouseEventArgs e)
        {
            if (_dragging)
            {
        ...
        private void EasyTest1_MouseUp(object sender, MouseEventArgs e)
        {
            _dragging = false;
        }

        // Key shortcuts
        private void EasyTest1_KeyDown(object sender, KeyEventArgs e)
        {
