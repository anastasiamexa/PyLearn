...
{
    public partial class Theory6 : Form
    {
        private bool _dragging = false;
        private Point _start_point = new Point(0, 0);
        string username = "";

        public Theory6(string u)
        {
            InitializeComponent();
            username = u;
        }
        ...
        private void Theory6_MouseDown(object sender, MouseEventArgs e)
        {
            _dragging = true;
            _start_point = new Point(e.X, e.Y);
        }

        private void Theory6_MouseMove(object sender, MouseEventArgs e)
        {
            if (_dragging)
            {
        ...
        private void Theory6_MouseUp(object sender, MouseEventArgs e)
        {
            _dragging = false;
        }

        // Key shortcuts
        private void Theory6_KeyDown(object sender, KeyEventArgs e)
        {
