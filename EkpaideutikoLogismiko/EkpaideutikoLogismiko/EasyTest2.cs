...
{
    public partial class EasyTest2 : Form
    {
        ...
        public EasyTest2(string u)
        {
            ...
            string query = "select * from multiplechoice inner join questions on multiplechoice.id= questions.id where chapter=2";
            ...
            string query2 = "select * from truefalse inner join questions on truefalse.id= questions.id where chapter=2";
        ...
        private void EasyTest2_MouseDown(object sender, MouseEventArgs e)
        {
            _dragging = true;
            _start_point = new Point(e.X, e.Y);
        }

        private void EasyTest2_MouseMove(object sender, MouseEventArgs e)
        {
            if (_dragging)
            {
        ...
        private void EasyTest2_MouseUp(object sender, MouseEventArgs e)
        {
            _dragging = false;
        }

        // Key shortcuts
        private void EasyTest2_KeyDown(object sender, KeyEventArgs e)
        {
