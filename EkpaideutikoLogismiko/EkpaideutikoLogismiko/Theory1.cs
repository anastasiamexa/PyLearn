...
namespace EkpaideutikoLogismiko
{
    public partial class Theory1 : Form
    {
        ...
        private void Theory1_MouseDown(object sender, MouseEventArgs e)
        {
            _dragging = true;
            _start_point = new Point(e.X, e.Y);
        }

        private void Theory1_MouseMove(object sender, MouseEventArgs e)
        {
            if (_dragging)
            {
        ...
        private void Theory1_MouseUp(object sender, MouseEventArgs e)
        {
            _dragging = false;
        }

        // Key shortcuts
        private void Theory1_KeyDown(object sender, KeyEventArgs e)
        {
