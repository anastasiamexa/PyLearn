...
{
    public partial class HardTest3 : Form
    {
        ...
        public HardTest3(string u)
        {
            ...
            string query = "select * from fillgap inner join questions on fillgap.id= questions.id where chapter=3";
            ...
            string query2 = "select * from sequence inner join questions on sequence.id= questions.id where chapter=3";
        ...
        private void HardTest3_MouseDown(object sender, MouseEventArgs e)
        {
            _dragging = true;
            _start_point = new Point(e.X, e.Y);
        }

        private void HardTest3_MouseMove(object sender, MouseEventArgs e)
        {
            if (_dragging)
            {
        ...
        private void HardTest3_MouseUp(object sender, MouseEventArgs e)
        {
            _dragging = false;
        }

        // Key shortcuts
        private void HardTest3_KeyDown(object sender, KeyEventArgs e)
        {
